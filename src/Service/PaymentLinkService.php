...
class PaymentLinkService
{
    ...
    public function generatePaymentLink(string $orderId, Context $context): array
    {
        ...
        if ($transaction->getAmount()->getTotalPrice() !== $order->getAmountTotal()) {
            $this->updateTransactionAmount($transaction, $order, $context);
        }
...
//                 already partially paid
    ...
    private function updateTransactionAmount(
        ...
        $amount = $this->createCalculatedPriceForNewTransaction($order->getAmountTotal(), $transaction);
