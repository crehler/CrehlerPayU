...
class OrderCreate
{
    ...
    public function __construct(
        private readonly ConfigurationService $configurationFactor,
    ...
    public function createOrder(
        ...
        $this->configurationFactor->initialize(
            isBlik: $isBlik,
            salesChannel: $salesChannelContext->getSalesChannelId()
        );
