...
class PaymentMethodsRoute extends AbstractPaymentMethodsRoute
{
    ...
    public function getPaymentMethods(string $paymentMethodId, string $lang, SalesChannelContext $salesChannelContext): Response
    {
       ...
       $paymentMethodsWhiteList = array_key_exists(PaymentMethodUtil::PAYMENT_WL_CUSTOM_FIELD_NAME, $customFields) ? $customFields[PaymentMethodUtil::PAYMENT_WL_CUSTOM_FIELD_NAME] : null;
       if ($paymentMethodsWhiteList !== null && $paymentMethodsWhiteList !== "") {
        ...
        $paymentMethodsBlackList = array_key_exists(PaymentMethodUtil::PAYMENT_BL_CUSTOM_FIELD_NAME, $customFields) ? $customFields[PaymentMethodUtil::PAYMENT_BL_CUSTOM_FIELD_NAME] : null;
