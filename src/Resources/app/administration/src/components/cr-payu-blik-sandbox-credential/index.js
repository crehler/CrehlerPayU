...
Component.extend('cr-payu-blik-sandbox-credential', 'cr-payu-sandbox-credential', {
    template,
    inject: [
    ...
    methods: {
        onTestCredentials() {
            ...
            return this.systemConfigApiService.getValues('CrehlerPayU.config', null)
                .then(values => {
                    me.CrehlerPayuApiService.checkCredentials(values, true, true).then(checkResponse => {
